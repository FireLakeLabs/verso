      ...
      <section style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 48 }}>
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
            <a onClick={(e) => { e.preventDefault(); onNavigate("report-cadence"); }} style={{ borderBottom: "1px solid var(--line-2)", color: "var(--ink-900)", paddingBottom: 8, cursor: "pointer", display: "flex", justifyContent: "space-between" }}>
              <span>Listening cadence</span><span className="v-eyebrow">HEATMAP</span>
            </a>
            <a onClick={(e) => { e.preventDefault(); onNavigate("report-genre"); }} style={{ borderBottom: "1px solid var(--line-2)", color: "var(--ink-900)", paddingBottom: 8, cursor: "pointer", display: "flex", justifyContent: "space-between" }}>
              <span>Genre treemap</span><span className="v-eyebrow">MAP</span>
            </a>
            ...
            <a onClick={(e) => { e.preventDefault(); onNavigate("report-narrators"); }} style={{ borderBottom: "1px solid var(--line-2)", color: "var(--ink-900)", paddingBottom: 8, cursor: "pointer", display: "flex", justifyContent: "space-between" }}>
              <span>Narrator affinity</span><span className="v-eyebrow">VOICE</span>
            </a>
            ...
            <a onClick={(e) => { e.preventDefault(); onNavigate("report-cost"); }} style={{ borderBottom: "1px solid var(--line-2)", color: "var(--ink-900)", paddingBottom: 8, cursor: "pointer", display: "flex", justifyContent: "space-between" }}>
              <span>Cost per hour</span><span className="v-eyebrow">$/H</span>
            </a>
          </div>
        </div>
        <div>
